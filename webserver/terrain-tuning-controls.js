export function createTerrainTuningControls({
  ...
  function select(label, options) {
    ...
    input.style.cssText = 'flex:1;min-width:0;background:#182330;color:#9cf;border:1px solid #456;border-radius:3px;padding:2px 4px';
    for (const [value, text] of Object.entries(options.options)) {
