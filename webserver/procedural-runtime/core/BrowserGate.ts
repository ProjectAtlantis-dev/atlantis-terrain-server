...
export function browserGate(): boolean {
  ...
  if (isMobileDevice()) {
    failLoud('A computer is required', [
      'Atlantis procedural terrain uses desktop-class WebGPU features — phone and tablet',
  ...
  if (!isChromiumBrowser()) {
    failLoud('Google Chrome is required', [
      'Atlantis procedural terrain is built and tested against Chrome’s WebGPU implementation.',
