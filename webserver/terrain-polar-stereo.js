...
export function epsg3413DirectionBearing({ x, y, directionX, directionY }) {
  ...
  // Polar stereographic grid convergence is longitude minus the central
  // meridian. Convert a grid-axis heading to a true-north bearing.
  const bearing = gridBearing + lon - CENTRAL_MERIDIAN;
