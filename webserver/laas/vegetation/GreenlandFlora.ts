/**
 * GreenlandFlora — real-data species roster driving realistic scatter placement.
 *
 ...
 *   ~/hermes-data-flora/skills/terrain-flora-worker/
 *     greenland-species.md, greenland-species-expansion.md,
 *     biome-rules.md, biome-rules-expansion.md
 *
 ...
 * - ~/hermes-data-flora/skills/terrain-flora-worker/greenland-species.md
 *   & greenland-species-expansion.md — per-species base rate /km², max/tile,
 ...
 * - .../fable5-laas-comparison.md — confirms this LAAS engine as the target and
 *   the atlantis Arctic catalog as the species source.
