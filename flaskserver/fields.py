...
from classifier.guide_assets import classify
from classifier.training_data import terrain_channels
...
def compute_fields(
    ...
    _cls, veg = classify(rgb, southness=south)   # 0..1 vegetation, north-slope-masked
